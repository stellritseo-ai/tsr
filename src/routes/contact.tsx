                  ...
                  <form className="space-y-8 animate-fade-up">
                     <div className="grid md:grid-cols-2 gap-8">
                        <div className="group relative">
                           <input type="text" placeholder="Enter your full name" className="w-full bg-ink border-b border-white/20 py-5 px-0 text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors font-serif italic" />
                           <span className="absolute bottom-0 left-0 h-[1px] w-0 bg-gold group-focus-within:w-full transition-all duration-700" />
                        </div>
                        <div className="group relative">
                           <input type="email" placeholder="Your email address" className="w-full bg-ink border-b border-white/20 py-5 px-0 text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors font-serif italic" />
                           <span className="absolute bottom-0 left-0 h-[1px] w-0 bg-gold group-focus-within:w-full transition-all duration-700" />
                        </div>
                     </div>
                     ...
                     <div className="grid md:grid-cols-2 gap-8">
                        <div className="group relative">
                           <input type="tel" placeholder="Your phone number" className="w-full bg-ink border-b border-white/20 py-5 px-0 text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors font-serif italic" />
                           <span className="absolute bottom-0 left-0 h-[1px] w-0 bg-gold group-focus-within:w-full transition-all duration-700" />
                        </div>
                        <div className="group relative">
                           <input type="text" placeholder="How can we help?" className="w-full bg-ink border-b border-white/20 py-5 px-0 text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors font-serif italic" />
                           <span className="absolute bottom-0 left-0 h-[1px] w-0 bg-gold group-focus-within:w-full transition-all duration-700" />
                        </div>
                     </div>

                     <div className="group relative">
                        <textarea rows={5} placeholder="Write your message here…" className="w-full bg-ink border-b border-white/20 py-5 px-0 text-white placeholder:text-white/30 focus:outline-none focus:border-gold transition-colors font-serif italic resize-none" />
                        <span className="absolute bottom-0 left-0 h-[1px] w-0 bg-gold group-focus-within:w-full transition-all duration-700" />
                     </div>

                     <div className="pt-10 flex justify-center">
                        <button className="group relative bg-gold text-ink px-16 py-6 rounded-full text-[10px] tracking-[0.5em] uppercase font-bold overflow-hidden shadow-luxe hover:bg-white hover:text-ink transition-all duration-500">
