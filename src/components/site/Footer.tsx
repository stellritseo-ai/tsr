    ...
    <footer className="relative bg-ink text-[oklch(0.88_0.04_75)] pt-24 pb-10 px-6">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-xs opacity-70">
          <div>© {new Date().getFullYear()} TSR Skin and Hair Care. All rights reserved. Design By <a href="#" target="_blank" rel="noopener noreferrer" className="hover:underline hover:text-white transition">Lambton Labs</a></div>
